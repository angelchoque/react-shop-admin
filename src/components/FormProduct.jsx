  ...
  const handleSubmit = (event) => {
    ...
    if (product) {
      updateProduct(product.id, data)
        .then((response) => router.push("/dashboard/products/"))
    } else {
          ...
          <div className="grid grid-cols-6 gap-6">
            ...
            <div className="col-span-6">
              ...
              <textarea
                ...
                rows="3"
                className="form-textarea mt-1 block focus:ring-indigo-500 focus:border-indigo-500  w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
              />
            </div>
            <div className="col-span-6">
              <div>
